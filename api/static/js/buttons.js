...
(function () {
    ...
    var getColorScheme = function (declarations) {
        ...
        return (
            widgetColorSchemes[hasOwnProperty(widgetColorSchemes, colorSchemes["no-preference"]) ? colorSchemes["no-preference"] : "light"] +
    ...
    var render$1 = function (root, options, func) {
        ...
        if (
            ((hostname === domain || hostname === "gist." + domain) && path[3] === "archive") ||
